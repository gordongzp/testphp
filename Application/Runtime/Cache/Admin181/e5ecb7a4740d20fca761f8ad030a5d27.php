...
<div class="header-container">
				...
				<div class="row">
					...
					<div class="main col-md-12">
						...
						<div class="row">
							<div class="col-sm-8">
								<?php
 switch ($user['person_identify_stage']){ case 0: ?>
 ...
 break; default: break;}?>
							...
							<div class="row"></div>
							<form onkeydown="if(event.keyCode==13){return false;}" action="<?php echo U('Admin181/User/identifyId',array('id'=>$user['id'],));?>" method="POST" role="form">
								<div class="col-sm-4">
									<!-- 传id -->
								...
								<div class="col-sm-4">
									<div class="image-box style-2 mb-20">
										<div class="overlay-container overlay-visible">
											<img style="height: 260px" src="<?php echo U(USERS_PATH.I('get.id').'/identify1','','jpg');?>" alt="">
											<a href="<?php echo U(USERS_PATH.I('get.id').'/identify1','','jpg');?>" class="overlay-link popup-img"><i class="fa fa-plus"></i></a>
								...
								<div class="col-sm-4">
									<div class="image-box style-2 mb-20">
										<div class="overlay-container overlay-visible">
											<img style="height: 260px" src="<?php echo U(USERS_PATH.I('get.id').'/identify2','','jpg');?>" alt="" >
											<a href="<?php echo U(USERS_PATH.I('get.id').'/identify2','','jpg');?>" class="overlay-link popup-img"><i class="fa fa-plus"></i></a>
											<div class="overlay-bottom hidden-xs">
												<div class="text">
								...
								<div class="col-sm-4 col-sm-offset-4">
									<div class="radio">
										<label>
											<input type="radio" name="person_identify_stage" id="person_identify_stage0" value="0" checked="">
											未提交审核
										</label>
									</div>
									<div class="radio">
										<label>
											<input type="radio" name="person_identify_stage" id="person_identify_stage1" value="1" checked="">
											已提交审核
										</label>
									</div>
									<div class="radio">
										<label>
											<input type="radio" name="person_identify_stage" id="person_identify_stage2" value="2" checked="">
											审核不通过
										</label>
									</div>
									<div class="radio">
										<label>
											<input type="radio" name="person_identify_stage" id="person_identify_stage3" value="3" checked="">
											审核通过
										</label>
									</div>
...
<script type="text/javascript">
//
	<?php  switch ($user['person_identify_stage']) { case 0: ?>
		document.getElementById("person_identify_stage0").checked=true;
		<?php  break; case 1: ?>
		document.getElementById("person_identify_stage1").checked=true;
		<?php  break; case 2: ?>
		document.getElementById("person_identify_stage2").checked=true;
		<?php  break; case 3: ?>
		document.getElementById("person_identify_stage3").checked=true;
		<?php  break; } ?>
</script>
