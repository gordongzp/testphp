 ...
 break; default: break;}?>
							...
							<form onkeydown="if(event.keyCode==13){return false;}" action="<?php echo U('Admin181/User/identityId',array('id'=>$user['id'],));?>" method="POST" role="form">
								...
								<div class="col-sm-4 col-sm-offset-4">
									<div class="radio">
										<label>
											<input type="radio" name="person_identity_stage" id="person_identity_stage0" value="0" checked="">
											未提交审核
										</label>
									</div>
									<div class="radio">
										<label>
											<input type="radio" name="person_identity_stage" id="person_identity_stage1" value="1" checked="">
											已提交审核
										</label>
									</div>
									<div class="radio">
										<label>
											<input type="radio" name="person_identity_stage" id="person_identity_stage2" value="2" checked="">
											审核不通过
										</label>
									</div>
									<div class="radio">
										<label>
											<input type="radio" name="person_identity_stage" id="person_identity_stage3" value="3" checked="">
											审核通过
										</label>
									</div>
...
<script type="text/javascript">
//
	<?php  switch ($user['person_identity_stage']) { case 0: ?>
		document.getElementById("person_identity_stage0").checked=true;
		<?php  break; case 1: ?>
		document.getElementById("person_identity_stage1").checked=true;
		<?php  break; case 2: ?>
		document.getElementById("person_identity_stage2").checked=true;
		<?php  break; case 3: ?>
		document.getElementById("person_identity_stage3").checked=true;
		<?php  break; } ?>
</script>
