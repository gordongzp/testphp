			...
			<div class="container">
				<div class="object-non-visible text-center" data-animation-effect="fadeInDownSmall" data-effect-delay="100">
					...
					<div id="block1" class="form-block center-block p-30 light-gray-bg border-clear text-left">
						...
						<form onkeydown="if(event.keyCode==13){return false;}" method="post" class="form-horizontal" role="form" action="<?php echo U('Home/User/signUp');?>">
							...
							<div class="form-group has-feedback">
								...
								<div class="col-sm-4">
									<input name="check_tel" id="check_tel" type="text" class="form-control"  placeholder="" required>
					...
					<div id="block2" style="display: none;" class="form-block center-block p-30 light-gray-bg border-clear text-left">
						...
						<form onkeydown="if(event.keyCode==13){return false;}" method="post" class="form-horizontal" role="form">
