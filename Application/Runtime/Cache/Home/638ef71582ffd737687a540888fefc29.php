...
<ul class="nav nav-tabs style-2" role="tablist">
								...
								<div class="tab-content">
									<div class="tab-pane in active" id="h2tab1">
										<div class="row">
											<div class="col-sm-12">
												<?php
 switch ($person_identify_stage) { case 0: ?>
 ...
 break; default: break; } ?>
										...
										<div class="row">
											<div class="col-sm-5">
												<form onkeydown="if(event.keyCode==13){return false;}" action="<?php echo U('Home/UserCenter/identifyId');?>" method="POST" role="form" enctype="multipart/form-data">
