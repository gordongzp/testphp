									...
									<div class="tab-pane in active" id="h2tab1">
										<div class="row">
											<div id="block1" class="col-sm-5">
												<form onkeydown="if(event.keyCode==13){return false;}" action="<?php echo U('Home/UserCenter/createEmail');?>" method="POST" role="form">
													<input type="text" name="id" value="<?php echo session('user.id');?>" style="display: none;">
													<div class="form-group">
														<label for="">邮箱</label>
														<input name="email" id="email" type="test" class="form-control" placeholder="" value="<?php echo session('user.email');?>">
													</div>
													<div class="form-group">
														<label for="">邮箱验证码</label>
														<input name="check_email" id="check_email" type="text" class="form-control" placeholder="">
													</div>							
