																		...
																		<div class="row">
																			...
																			<div class="col-sm-6 col-md-3">
																				...
																				<ul class="menu">
																					...
																					<li class="active"><a href="index-portfolio.html"><i class="icon-briefcase pr-10"></i>Portfolio/Agency</a></li>
															...
															<li>
																<div class="row">
																	...
																	<div class="col-lg-4 col-md-3 hidden-sm">
																		...
																		<img src="/Public/images/section-image-3.png" alt="The Project">
																	</div>
																</div>
															</li>
														</ul>
					...
					<div class="slider-banner-fullscreen">
						<ul class="slides">
							...
							<li data-transition="random" data-slotamount="7" data-masterspeed="500" data-saveperformance="on" data-title="Powerful Bootstrap Template">
								...
								<!-- main image -->
								<img src="/Public/images/portfolio-slider-slide-1.jpg" alt="slidebg1" data-bgposition="center top"  data-bgrepeat="no-repeat" data-bgfit="cover">
...
<li data-transition="random" data-slotamount="7" data-masterspeed="500" data-saveperformance="on" data-title="Premium HTML5 Bootstrap Theme">
	...
	<!-- main image -->
	<img src="/Public/images/portfolio-slider-slide-2.jpg" alt="slidebg2" data-bgposition="center top"  data-bgrepeat="no-repeat" data-bgfit="cover">
		...
		<div class="container">
			...
			<div class="isotope-container row grid-space-0">
					...
					<div id="carousel-portfolio" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner" role="listbox">
							...
							<div class="item">
								<div class="image-box text-center">
									<div class="overlay-container">
										<img src="/Public/images/portfolio-1-2.jpg" alt="">
										<div class="overlay-top">
											<div class="text">
												<h3><a href="portfolio-item.html">Project Title</a></h3>
												<p class="small">Web Design</p>
							...
							<div class="item">
								<div class="image-box text-center">
									<div class="overlay-container">
										<img src="/Public/images/portfolio-1-3.jpg" alt="">
										<div class="overlay-top">
											<div class="text">
												<h3><a href="portfolio-item.html">Project Title</a></h3>
												<p class="small">Web Design</p>
				...
				<div class="col-sm-6 col-md-3 isotope-item site-building">
					<div class="image-box text-center">
						<div class="overlay-container">
							<img src="/Public/images/portfolio-7.jpg" alt="">
							<div class="overlay-top">
								<div class="text">
									<h3><a href="portfolio-item.html">Project Title</a></h3>
									<p class="small">Site Building</p>
				...
				<div class="col-sm-6 col-md-3 isotope-item app-development">
					<div class="image-box text-center">
						<div class="overlay-container">
							<img src="/Public/images/portfolio-8.jpg" alt="">
							<div class="overlay-top">
								<div class="text">
									<h3><a href="portfolio-item.html">Project Title</a></h3>
									<p class="small">App Development</p>
					...
					<div id="carousel-portfolio-2" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner" role="listbox">
							<div class="item active">
								<div class="image-box text-center">
									<div class="overlay-container">
										<img src="/Public/images/portfolio-9.jpg" alt="">
										<div class="overlay-top">
											<div class="text">
												<h3><a href="portfolio-item.html">Project Title</a></h3>
												<p class="small">Web Design</p>
							...
							<div class="item">
								<div class="image-box text-center">
									<div class="overlay-container">
										<img src="/Public/images/portfolio-1-4.jpg" alt="">
										<div class="overlay-top">
											<div class="text">
												<h3><a href="portfolio-item.html">Project Title</a></h3>
												<p class="small">Web Design</p>
							...
							<div class="item">
								<div class="image-box text-center">
									<div class="overlay-container">
										<img src="/Public/images/portfolio-1-5.jpg" alt="">
										<div class="overlay-top">
											<div class="text">
												<h3><a href="portfolio-item.html">Project Title</a></h3>
												<p class="small">Web Design</p>
				...
				<div class="col-sm-6 col-md-3 isotope-item app-development">
					<div class="image-box text-center">
						<div class="overlay-container">
							<img src="/Public/images/portfolio-10.jpg" alt="">
							<div class="overlay-top">
								<div class="text">
									<h3><a href="portfolio-item.html">Project Title</a></h3>
									<p class="small">App Development</p>
				...
				<div class="col-sm-6 col-md-3 isotope-item app-development">
					<div class="image-box text-center">
						<div class="overlay-container">
							<img src="/Public/images/portfolio-11.jpg" alt="">
							<div class="overlay-top">
								<div class="text">
									<h3><a href="portfolio-item.html">Project Title</a></h3>
									<p class="small">App Development</p>
				...
				<div class="col-sm-6 col-md-3 isotope-item web-design">
					<div class="image-box text-center">
						<div class="overlay-container">
							<img src="/Public/images/portfolio-12.jpg" alt="">
							<div class="overlay-top">
								<div class="text">
									<h3><a href="portfolio-item.html">Project Title</a></h3>
									<p class="small">Web Design</p>
				...
				<div class="col-sm-6 col-md-3 isotope-item site-building">
					<div class="image-box text-center">
						<div class="overlay-container">
							<img src="/Public/images/portfolio-13.jpg" alt="">
							<div class="overlay-top">
								<div class="text">
									<h3><a href="portfolio-item.html">Project Title</a></h3>
									<p class="small">Site Building</p>
				...
				<div class="col-sm-6 col-md-3 isotope-item app-development">
					<div class="image-box text-center">
						<div class="overlay-container">
							<img src="/Public/images/portfolio-14.jpg" alt="">
							<div class="overlay-top">
								<div class="text">
									<h3><a href="portfolio-item.html">Project Title</a></h3>
									<p class="small">App Development</p>
				...
				<div class="col-sm-6 col-md-3 isotope-item site-building">
					<div class="image-box text-center">
						<div class="overlay-container">
							<img src="/Public/images/portfolio-15.jpg" alt="">
							<div class="overlay-top">
								<div class="text">
									<h3><a href="portfolio-item.html">Project Title</a></h3>
									<p class="small">Site Building</p>
				...
				<div class="col-sm-6 col-md-3 isotope-item app-development">
					<div class="image-box text-center">
						<div class="overlay-container">
							<img src="/Public/images/portfolio-16.jpg" alt="">
							<div class="overlay-top">
								<div class="text">
									<h3><a href="portfolio-item.html">Project Title</a></h3>
									<p class="small">App Development</p>
					...
					<div class="col-md-8 col-md-offset-2">
						<div class="testimonial text-center">
							<div class="testimonial-image">
								<img src="/Public/images/testimonial-1.jpg" alt="Jane Doe" title="Jane Doe" class="img-circle">
							</div>
							<h3>Just Perfect!</h3>
							<div class="separator"></div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2">
						<div class="testimonial text-center">
							<div class="testimonial-image">
								<img src="/Public/images/testimonial-2.jpg" alt="Jane Doe" title="Jane Doe" class="img-circle">
							</div>
							<h3>Amazing!</h3>
							<div class="separator"></div>
							<div class="testimonial-body">
