											...
											<div id="block1" class="col-sm-5">
												<form onkeydown="if(event.keyCode==13){return false;}" action="<?php echo U('Home/UserCenter/comeBackPwd');?>" method="POST" role="form">
													<div class="form-group">
														...
														<input name="tel2" id="tel" type="text" class="form-control" placeholder="<?php echo (L2($msg["tel"])); ?>">
													</div>
													<div class="form-group">
														<label for="">新密码</label>
														<input name="pwd" type="password" class="form-control" id="" placeholder="<?php echo (L2($msg["user_pwd"])); ?>">
													</div>
													<div class="form-group">
														<label for="">确认密码</label>
														<input name="pwd2" type="password" class="form-control" id="" placeholder="<?php echo (L2($msg["user_pwd2"])); ?>">
													</div>
													<div class="form-group">
