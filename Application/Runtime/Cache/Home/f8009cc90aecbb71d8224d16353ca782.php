									...
									<div class="tab-pane in active" id="h2tab1">
										<div class="row">
											<div id="block1" class="col-sm-5">
												<form action="<?php echo U('Home/UserCenter/comeBackPwd');?>" method="POST" role="form">
													<div class="form-group">
														<label for="">注册手机号</label>
														<input name="tel2" id="tel" type="test" class="form-control" placeholder="<?php echo ($msg["tel"]); ?>">
													</div>
													<div class="form-group">
														<label for="">新密码</label>
